...
PANEL_OPTIONS_CONFIG = [
    ...
    {
        'titulo': 'Ocultar Referencias a Vendedores Externos',
        'descripcion': 'Controlar qué productos ven los vendedores externos en el catálogo.',
        'url_nombre': 'bodega:visibilidad_productos',
        'icono': 'fas fa-eye-slash',
        'icono_color_class': 'icon-secondary',
        'rol_requerido': ['es_bodega', 'es_administracion', 'es_diseno'],
        'categoria': 'Bodega e Inventario',
    },
    {
    ...
    {
        'titulo': 'Bodegas',
        'descripcion': 'Crear y administrar las bodegas/ubicaciones de inventario de la empresa.',
        'url_nombre': 'bodega:lista_bodegas',
    ...
    {
        'titulo': 'Accesos por Bodega',
        'descripcion': 'Configurar excepciones individuales de acceso de usuarios a bodegas específicas.',
        'url_nombre': 'bodega:lista_accesos_bodega',
    ...
    },
    {
        ...
        'descripcion': 'Registrar y gestionar traslados de mercancía entre bodegas.',
        'url_nombre': 'bodega:lista_traslados',
    ...
    },
    {
        ...
        'descripcion': 'Buscar un producto y ver al instante cuánto hay en cada bodega.',
        'url_nombre': 'bodega:consulta_stock_bodega',
        'icono': 'fas fa-bolt',
        'icono_color_class': 'icon-warning',
        'rol_requerido': ['es_bodega', 'es_administracion', 'es_diseno'],
        'categoria': 'Bodega e Inventario',
    ...
    {
        'titulo': 'Comparativo de Stock por Bodega',
        'descripcion': 'Tabla con el stock de cada producto en todas las bodegas, lado a lado.',
        'url_nombre': 'bodega:informe_inventario_comparativo',
    ...
    # --- Punto de Venta ---
    {
        ...
        'descripcion': 'Abrir una caja de Punto de Venta declarando el efectivo inicial.',
        'url_nombre': 'puntoventa:abrir_turno',
        'icono': 'fas fa-play-circle',
        'icono_color_class': 'icon-success',
        'rol_requerido': ['es_cajero', 'es_administracion'],
        'categoria': 'Punto de Venta',
    },
    {
        'titulo': 'Vender (Punto de Venta)',
        'descripcion': 'Pantalla de venta rápida de mostrador.',
        'url_nombre': 'puntoventa:vender',
    ...
    },
    {
        ...
        'descripcion': 'Cerrar el turno de caja actual y contar el efectivo.',
        'url_nombre': 'puntoventa:cerrar_turno',
    ...
    {
        'titulo': 'Historial de Ventas (POS)',
        'descripcion': 'Ver, filtrar, reimprimir recibos y descargar el historial de ventas de Punto de Venta.',
        'url_nombre': 'puntoventa:historial_ventas',
    ...
    {
        'titulo': 'Precios de Saldo (POS)',
        'descripcion': 'Fijar un precio especial de liquidación por producto para una bodega de Punto de Venta.',
        'url_nombre': 'puntoventa:gestionar_precios_pos',
        'icono': 'fas fa-tags',
        'icono_color_class': 'icon-warning',
        'rol_requerido': ['es_administracion'],
        'categoria': 'Punto de Venta',
    ...
    {
        'titulo': 'Consulta de Inventario (POS)',
        'descripcion': 'Ver el stock disponible en tu bodega de Punto de Venta.',
        'url_nombre': 'puntoventa:consulta_inventario_pos',
    ...
    {
        'titulo': 'Registrar Salida (POS)',
        'descripcion': 'Registrar salidas de mercancía desde el Punto de Venta (préstamo, baja, entrega a terceros, etc.).',
        'url_nombre': 'puntoventa:registrar_salida_pos',
    ...
    {
        'titulo': 'Salidas Registradas (POS)',
        'descripcion': 'Historial de salidas de mercancía del Punto de Venta.',
        'url_nombre': 'puntoventa:lista_salidas_pos',
        'icono': 'fas fa-list',
        'icono_color_class': 'icon-secondary',
        'rol_requerido': ['es_cajero', 'es_administracion'],
        'categoria': 'Punto de Venta',
    ...
    {
        'titulo': 'Devolución / Cambio (POS)',
        'descripcion': 'Procesar la devolución o el cambio de un producto vendido en el Punto de Venta.',
        'url_nombre': 'puntoventa:devolucion_cambio',
        'icono': 'fas fa-right-left',
        'icono_color_class': 'icon-danger',
        'rol_requerido': ['es_cajero', 'es_administracion'],
        'categoria': 'Punto de Venta',
    },
    {
        'titulo': 'Historial de Devoluciones/Cambios (POS)',
        'descripcion': 'Ver el historial de devoluciones y cambios procesados en el Punto de Venta.',
        'url_nombre': 'puntoventa:historial_devoluciones_cambios',
        'icono': 'fas fa-history',
        'icono_color_class': 'icon-secondary',
        'rol_requerido': ['es_cajero', 'es_administracion'],
        'categoria': 'Punto de Venta',
    ...
    },
    {
        ...
        'descripcion': 'Crear un nuevo producto y sus variantes.',
        'url_nombre': 'productos:producto_crear',
    ...
    {
        'titulo': 'Sincronizar Shopify',
        'descripcion': 'Sincronizar productos y stock con la tienda Shopify.',
        'url_nombre': 'pedidos_web:panel_sincronizacion',
    ...
    {
        'titulo': 'Catálogo Shopify',
        'descripcion': 'Elegir qué referencias subir, actualizar o bajar de la tienda Shopify.',
        'url_nombre': 'pedidos_web:gestion_catalogo_shopify',
    ...
    # --- Informes Generales ---
    {
        ...
        'descripcion': 'Ventas por vendedor, filtrable por canal (Estándar, Online, Web).',
        'url_nombre': 'informes:reporte_ventas',
        'icono': 'fas fa-chart-bar',
        'icono_color_class': 'icon-primary',
        'rol_requerido': ['es_vendedor', 'es_online', 'es_administracion'],
        'order': 4,
    ...
    
    {
        ...
        'icono': 'fas fa-tshirt',
        'icono_color_class': 'icon-info',        
        'rol_requerido': ['es_cartera', 'es_bodega', 'es_administracion'],
        'order': 6,
        'categoria': 'Informes Generales',
    },
    {
        ...
        'icono': 'fas fa-history',
        'icono_color_class': 'icon-primary',
        'rol_requerido': ['bodega.view_cabeceraconteo', 'es_administracion'],
        'categoria': 'Informes Generales',
    },
    {
    ...
    },
    {
        ...
        'descripcion': 'Activar o desactivar, por empresa, los módulos del panel (ej. Punto de Venta).',
        'url_nombre': 'core:gestionar_modulos_empresa',
        'icono': 'fas fa-toggle-on',
        'icono_color_class': 'icon-dark',
        'rol_requerido': 'es_superusuario', # Solo el superusuario ve esta opción
        'categoria': 'Administración del Sistema',
    },
]