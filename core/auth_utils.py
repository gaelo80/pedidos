...
def es_administracion(user):
    """Devuelve True si el usuario es superusuario o pertenece al grupo 'Administracion'."""
    if not user.is_authenticated:
        return False
    if user.is_superuser:
        return True
...
def es_bodega(user):
    """Devuelve True si el usuario es superusuario o pertenece al grupo 'Bodega'."""
    if not user.is_authenticated:
        return False
    if user.is_superuser:
        return True
...
def es_vendedor(user):
    """Devuelve True si el usuario es superusuario o pertenece al grupo 'Vendedores'."""
    if not user.is_authenticated:
        return False
    if user.is_superuser:
        return True
...
def es_cartera(user):
    """Devuelve True si el usuario es superusuario o pertenece al grupo 'Cartera'."""
    if not user.is_authenticated:
        return False
    if user.is_superuser:
        return True
...
def es_factura(user):
    """Devuelve True si el usuario es superusuario o pertenece al grupo 'Factura'."""
    if not user.is_authenticated:
        return False
    if user.is_superuser:
        return True
...
def es_diseno(user):
    """Devuelve True si el usuario es superusuario o pertenece al grupo 'Diseño'."""
    if not user.is_authenticated:
        return False
    if user.is_superuser:
        return True
...
def es_online(user):
    """Devuelve True si el usuario es superusuario o pertenece al grupo 'Online'."""
    if not user.is_authenticated:
        return False
    if user.is_superuser:
        return True
